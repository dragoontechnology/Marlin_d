...
#define STRING_CONFIG_H_AUTHOR "(Chad, Ender-3 Max)" // Who made the changes.
...
#define HEATER_0_MAXTEMP 295 // E3D thermistor max - Sean
...
#define NOZZLE_TO_PROBE_OFFSET {  50, -6, 0 }  // ENABLE FOR BLTOUCH - CHADDEVOPS
