...
#define STRING_CONFIG_H_AUTHOR "(Sean, Ender 3)" // Who made the changes.
...
//#define HEATER_0_MAXTEMP 305 // ALL COPPER BLOCK - CHADDEVOPS
#define HEATER_0_MAXTEMP 275 // STOCK - CHADDEVOPS
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 6000, 6000, 300, 6000 } // CHADDEVOPS
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 300, 20000 } // CHADDEVOPS
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013 // (mm) Distance from real junction edge // default is 0.013
...
#define NOZZLE_TO_PROBE_OFFSET {  -48, -8, 0 }  // ENABLE FOR BLTOUCH

// Micro Swis Direct Drive with https://www.thingiverse.com/thing:4621096 fan shroud -  ENABLE FOR BLTOUCH - CHADDEVOPS - OPTIONAL
//#define NOZZLE_TO_PROBE_OFFSET {  -47, -15, 0 }
...
#define DELAY_BEFORE_PROBING 350  // (ms) To prevent vibrations from triggering piezo sensors // CHADDEVOPS

// Require minimum nozzle and/or bed temperature for probing
#define PREHEAT_BEFORE_PROBING // ENABLE FOR BLTOUCH - CHADDEVOPS
...
#define X_BED_SIZE 199 // to clear clips
#define Y_BED_SIZE 199 // to clear clips
 ...
 */
//#define RESTORE_LEVELING_AFTER_G28  // ENABLE FOR BLTOUCH - CHADDEVOPS - OPTIONAL
 ...
 */
#define LCD_BED_LEVELING  // Add bed leveling menu items.
...
#define HOMING_FEEDRATE_MM_M { (50*100), (50*60), (4*60) } // CHADDEVOPS
...
//
// #define SPEAKER //comment out to save space
